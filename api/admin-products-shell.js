...
module.exports = async function handler(req,res){
  ...
  try{
    let html=fs.readFileSync(path.join(__dirname,"..","admin-products.html"),"utf8");
    if(!/promo-management\.js/i.test(html)) html=html.replace(/<\/body>/i,'<script src="/js/promo-management.js"></script></body>');
  ...
  }catch(e){res.statusCode=500;return res.end("Admin product manager unavailable");}
};
