// ============================================================
// NEXT LEVEL SUBS
// PRODUCT SEO / OPEN GRAPH / SOCIAL PREVIEW API
// ============================================================
//
// Public URL:
//
...
//
// Social crawlers are internally rewritten here:
//
...
//
// IMPORTANT:
// This file NEVER redirects the visitor.
//
...
// ============================================================
//
// WhatsApp/Facebook/etc. can be unreliable with SVG OG images.
//
// Therefore SVG products use the site's fallback logo instead.
//
// BEST PRACTICE:
// Replace these SVG paths with PNG/WebP product artwork later.
//
// ============================================================
