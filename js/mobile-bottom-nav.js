(function () {
    ...
    function injectStyles() {
        ...
        style.textContent = `
            ...
            @media(max-width:1024px){body{padding-bottom:100px!important}#${NAV_ID}{display:block!important;visibility:visible!important;opacity:1!important;transform:none!important;bottom:max(10px,env(safe-area-inset-bottom))!important}}
            ...
            @media(prefers-reduced-motion:reduce){#${NAV_ID} .nls-bn-slider,#${NAV_ID} .nls-bn-item,#${NAV_ID} .nls-bn-item i,#${NAV_ID} .nls-bn-item .nls-bn-avatar,#${NAV_ID} .nls-bn-item .nls-bn-label{transition-duration:.01ms!important}}
        `;
