(function () {
    ...
    function initChatFab() {
        ...
        style.innerHTML = `
            ...
            @keyframes typing {
                from { width: 0; }
                to { width: 32ch; } /* Smoothly types exactly 32 characters */
            }
        ...
        `;
        // Appending to <html> instead of <body> prevents frameworks from overwriting it
        document.documentElement.appendChild(bubbleBox);
