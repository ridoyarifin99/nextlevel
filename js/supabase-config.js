...
(function () {
    ...
    load('script[data-nextlevel-profile-system]', '/js/profile.js?v=20260908-1', 'nextlevelProfileSystem');
    load('script[data-nextlevel-dashboard-avatar-fix]', '/js/dashboard-avatar-fix.js?v=20260908-1', 'nextlevelDashboardAvatarFix');
