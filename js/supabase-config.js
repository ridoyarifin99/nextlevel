...
(function(){
  ...
  load('script[data-nextlevel-central-catalog]','/js/central-catalog.js?v=20260912-2','nextlevelCentralCatalog');
  ...
  if(/\/dashboard\.html$/i.test(path)){load('script[data-nextlevel-dashboard-central-sync]','/js/dashboard-central-sync.js?v=20260912-2','nextlevelDashboardCentralSync');load('script[data-nextlevel-dashboard-buttons-responsive]','/js/dashboard-buttons-responsive.js?v=20260908-2','nextlevelDashboardButtonsResponsive');}
  if(isDetailsPage){
  ...
  if(/\/checkout\.html$/i.test(path)){
    ...
    setTimeout(()=>load('script[data-nextlevel-checkout-central-guard]','/js/checkout-central-order-guard.js?v=20260912-2','nextlevelCheckoutCentralGuard'),0);
  }
